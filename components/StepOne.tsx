            ...
            <label className="flex items-center space-x-3 cursor-pointer group">
              <div className="relative">
                <input 
                  type="checkbox" 
                  name="willReform"
                  checked={!!formData.willReform}
                  onChange={handleChange}
                  className="peer sr-only" 
                />
                <div className="w-6 h-6 border-2 border-gray-200 rounded-md peer-checked:bg-[#669900] peer-checked:border-[#669900] transition-all"></div>
                <CheckCircle2 className="w-4 h-4 text-white absolute top-1 left-1 opacity-0 peer-checked:opacity-100 transition-all" />
              </div>
              <span className="text-xs font-bold text-gray-600 uppercase group-hover:text-[#669900] transition-colors">Reforma</span>
            </label>
            <label className="flex items-center space-x-3 cursor-pointer group">
              <div className="relative">
                <input 
              ...
              <span className="text-xs font-bold text-gray-600 uppercase group-hover:text-[#669900] transition-colors">Instalación</span>
            </label>
          </div>
        </div>
